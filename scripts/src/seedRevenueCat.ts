...
const PROJECT_NAME = "Intermingled";

const PRODUCT_IDENTIFIER = "premium_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "premium_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "Intermingled Premium Monthly";
const PRODUCT_USER_FACING_TITLE = "Intermingled Premium";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "Intermingled iOS";
const APP_STORE_BUNDLE_ID = "com.intermingled.app";
const PLAY_STORE_APP_NAME = "Intermingled Android";
const PLAY_STORE_PACKAGE_NAME = "com.intermingled.app";
...
// $9.99/month — competitive for social/dating apps (RevenueCat SoSA 2026)
...
async function seedRevenueCat() {
  ...
  console.log("====================");
  console.log("\nNext steps:");
  console.log("1. Set EXPO_PUBLIC_REVENUECAT_TEST_API_KEY to the Test Store key above");
  console.log("2. Set EXPO_PUBLIC_REVENUECAT_IOS_API_KEY to the App Store key above");
  console.log("3. Set EXPO_PUBLIC_REVENUECAT_ANDROID_API_KEY to the Play Store key above");
  console.log("4. Set REVENUECAT_PROJECT_ID to:", project.id);
  console.log("5. Set REVENUECAT_SECRET_KEY to your RevenueCat secret key (V2 REST key)");
  console.log("====================\n");
}
